...
public class FrameDate extends JFrame implements ActionListener
{
    ...
    public FrameDate(PanelBouton panelBouton, PanelMPM panelMPM, FrameMPM frame)
    {
    ...
    public String getTexteDebut() { return this.txtDebut.getText(); }

    public void afficherDate() { this.frame.afficherDate(); }
